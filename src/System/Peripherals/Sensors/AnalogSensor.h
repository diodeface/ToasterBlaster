...
#include "System/Peripherals/Sensors/Sensor.h"
...
class AnalogSensor : public Sensor {
  ...
  public:
    ...
    void setTriggerMultiplier(u8 multiplier) {
        setTriggerMultiplier(multiplier / 255.0f);
    }
    ...
    u8 getTriggerMultiplier() {
        return nearbyint(triggerMultiplier*255);
    }
